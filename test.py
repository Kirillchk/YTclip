...
bot = telebot.TeleBot(TOKEN) # getting it from https://t.me/BotFather after creating a new bot
...
def download_vid(message, resolution):
    yt = YouTube("https://www.youtube.com/watch?v=BV7BMtBNmyI")
